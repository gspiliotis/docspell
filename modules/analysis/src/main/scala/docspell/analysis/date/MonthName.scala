...
object MonthName {
  ...
  private val greek = List(
    List("ιανουάριος", "ιαν", "ιανουαριος", "ιανουαρίου"),
    List("φεβρουάριος", "φεβ", "φεβρουαριος", "φεβρουαρίου"),
    List("μάρτιος", "μαρ", "μαρτιος", "μαρτίου"),
    List("απρίλιος", "απρ", "απριλιος", "απριλίου"),
    List("μάιος", "μαι", "μαιος", "μαϊου"),
    List("ιούνιος", "ιουν", "ιουνιος", "ιουνίου"),
    List("ιούλιος", "ιουλ", "ιουλιος", "ιουλίου"),
    List("αύγουστος", "αυγ", "αυγουστος", "αυγούστου"),
    List("σεπτέμβριος", "σεπ", "σεπτεμβριος", "σεπτεμβρίου"),
    List("οκτώβριος", "οκτ", "οκτωβριος", "οκτωβρίου"),
    List("νοέμβριος", "νοε", "νοεμβριος", "νοεμβρίου"),
    List("δεκέμβριος", "δεκ", "δεκεμβριος", "δεκεμβρίου")
  )
}
